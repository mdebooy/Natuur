...
public final class NatuurTestConstants {
  ...
  public static final String  FAMILIELATIJNSENAAM       = "Aalscholvers";
  public static final Long    FAMILIENIVEAU             = 18L;
  public static final String  FAMILIEOPMERKING          = "fa opmerking";
  public static final String  FAMILIERANG               = "fa";
  public static final String  FAMILIERANGNAAM           = "familie";
  public static final Long    FAMILIETAXONID            = 1259L;
  public static final String  FAMILIETAXONNAAM          = "Aalscholvers";
  public static final Long    FAMILIEVOLGNUMMER         = 789L;
  ...
  public static final String  GESLACHTLATIJNSENAAM      = "Phalacrocorax";
  public static final String  GESLACHTNAAM              = "Aalscholver";
  public static final Long    GESLACHTNIVEAU            = 22L;
  public static final String  GESLACHTOPMERKING         = "ge opmerking";
  public static final String  GESLACHTRANG              = "ge";
  public static final String  GESLACHTRANGNAAM          = "geslacht";
  public static final Long    GESLACHTTAXONID           = 2005L;
  public static final Long    GESLACHTVOLGNUMMER        = 6789L;
  ...
  public static final String  LATIJNSENAAM_GR           =
      "Rynchops flavirostris";
  public static final String  LATIJNSENAAM_KL           =
  ...
  public static final int     REGIOLIJST_HASH           = 1048840392;
  ...
  public static final String  TAXONBESCHRIJVING         = "beschrijving";
  public static final int     TAXONBESCHRIJVING_HASH    = 102195110;
  public static final String  TAXONBESCHRIJVINGTYPE     = "kleed";
  public static final String  TAXONBESCHRIJVINGTYPE_GR  = "winter";
  public static final String  TAXONBESCHRIJVINGTYPE_KL  = "gebied";
